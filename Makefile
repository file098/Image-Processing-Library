testMain(27/05/2020):
	...
	gcc main.c bmp.o ip_lib.o -o testMain -Wall --ansi --pedantic -lm -g3 -fsanitize=address -fsanitize=undefined -std=gnu89 -Wextra 
	./testMain
	#rm testMain

test: main.o bmp.o ip_lib.o
	gcc bmp.o main.o ip_lib.o -o test -lm -g3 -fsanitize=address -fsanitize=undefined -Wextra
